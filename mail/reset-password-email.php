...
/* @var $newPassword string The new password that has been generated for the user */
?>
<!DOCTYPE html>
<html lang="en">
        ...
        <table role="presentation" class="email-content">
            <tr>
                <td class="email-header">
                    <h1>Password Reset - Doctors Coaching Academy</h1>
                </td>
            </tr>
            <tr>
                <td class="email-body">
                    ...
                    <p><strong style="font-size: 2rem;"><?= $newPassword ?></strong></p>
                    <p>Please log in with this password and make sure to change it after logging in to something more secure.</p>
